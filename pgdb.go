...
func ToDb[T any](Ctx context.Context, DB DB, data []T, table string, schema string) (int64, error) {
...
func getTableColumns(Ctx context.Context, DB DB, table string, schema string) (string, string, error) {
	var columns []string
